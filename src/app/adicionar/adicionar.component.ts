...
export class AdicionarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    {id: 1, name: 'Mário', idade: 39, sexo: 'Masculino', area: 'TI', cidade: 'Lisboa', endereco: 'R Marques Silva, 14 - Arroios', cargo: 'Dev Front-end', country: 'Portugal'},
    // tslint:disable-next-line:max-line-length
    {id: 2, name: 'Ana Luiza', idade: 37, sexo: 'Feminino', area: 'Ambiental', cidade: 'Lisboa', endereco: 'R Marques Silva, 14 - Arroios', cargo: 'Gestora Ambiental', country: 'Portugal'},
     // tslint:disable-next-line:max-line-length
    {id: 3, name: 'Marronzinho', idade: 4, sexo: 'Masculino', area: 'CASA', cidade: 'Lisboa', endereco: 'R Marques Silva, 14 - Arroios', cargo: 'Boca podi', country: 'Portugal'},
  ];
